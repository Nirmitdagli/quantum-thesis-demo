...
![HERO-S architecture](figures_aiiot_revision/hero_s_architecture.png)
...
![IDS F1](figures_aiiot_revision/all_datasets_ids_f1.png)
...
![Scheduler baseline comparison](figures_aiiot_revision/scheduler_baseline_comparison.png)

![Thirty-seed F1 boxplot](figures_aiiot_revision/hero_s_f1_boxplot.png)
...
![Deadline-constrained tradeoff](figures_aiiot_revision/deadline_constrained_tradeoff.png)

![Energy-latency tradeoff](figures_aiiot_revision/scheduler_energy_latency_tradeoff.png)
...
![QPU queue sensitivity](figures_aiiot_revision/scheduler_qpu_call_rate_queue_sensitivity.png)
